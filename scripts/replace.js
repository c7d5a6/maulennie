...
const replaceText = (text) => {
    let result = text;
    result = replaceMiak(result);
    result = replaceI(result);
    result = replaceT(result);
    result = replaceD(result);
    result = replaceS(result);
    result = replaceZ(result);
    result = replaceSH(result);
    result = replaceZH(result);
    result = replaceDZH(result);
    result = replaceСH(result);
    result = replaceDZ(result);
    result = replaceС(result);
